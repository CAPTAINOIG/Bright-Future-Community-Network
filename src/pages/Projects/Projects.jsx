...
const projects = [
  {
    ...
    status: "Ongoing",
    description: "Establishing a well-equipped community library with 5,000+ books and computers.",
    beneficiaries: "500+ Students",
    location: "Ogbomoso South",
    outcomes: ["Library renovated", "2,000+ books donated", "Internet installed"],
  ...
  },
  {
    ...
    status: "Completed",
    description: "Three-day intensive workshop covering digital skills, tailoring, and agribusiness.",
    beneficiaries: "120 Youth",
    location: "Ogbomoso",
    outcomes: ["120 youth trained", "35 started businesses", "15 secured employment"],
  ...
  },
  {
    ...
    status: "Planned",
    description: "Borehole construction in 5 underserved communities for clean drinking water.",
    beneficiaries: "2,000+ Residents",
    location: "Ogbomoso Area",
    outcomes: [],
  ...
  },
  {
    ...
    status: "Completed",
    description: "Complete renovation of 3 primary schools including roofing, painting, and furniture.",
    beneficiaries: "800 Students",
    location: "Ogbomoso North",
    outcomes: ["3 schools renovated", "240 desks provided", "6 toilet facilities"],
  ...
  },
  {
    ...
    status: "Ongoing",
    description: "6-month skills acquisition for 50 women in soap making, bead making, and business.",
    beneficiaries: "50 Women",
    location: "Ogbomoso",
    outcomes: ["50 women enrolled", "30 completed first module"],
  ...
  },
  {
    ...
    status: "Planned",
    description: "Free medical checkups, health education, and basic medication across 10 communities.",
        ...
        <div className="container-main relative z-10">
          <ScrollReveal className="text-center max-w-[700px] mx-auto">
            ...
            <p className="text-base text-white/85 max-w-[560px] mx-auto">
              Concrete actions creating real change in our communities.
            </p>
          </ScrollReveal>
        </div>
        ...
        <div className="container-main">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
            <div className="relative flex-1 max-w-[360px]">
              ...
              <input
                ...
                className="w-full py-3 px-4 pl-10 border border-gray-200 rounded-lg bg-white text-sm focus:outline-none focus:border-primary-600 focus:shadow-[0_0_0_3px_rgba(27,94,32,0.12)] transition-all placeholder:text-gray-400"
              />
            </div>
            <div className="flex gap-2 flex-wrap">
              {statuses.map((s) => (
                <button
                  key={s}
                  className={`px-4 py-2 border rounded-full text-sm font-medium cursor-pointer transition-all ${filter === s ? "bg-primary-600 text-white border-primary-600" : "bg-white text-gray-600 border-gray-200 hover:border-primary-600 hover:text-primary-600"}`}
                  onClick={() => setFilter(s)}
                >
                  {s}
                </button>
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-16">
              <Briefcase size={48} className="text-gray-300 mb-4 mx-auto" />
              ...
              {filtered.map((p) => (
                <Card key={p.id} variant="elevated">
                  <div className="h-[200px] overflow-hidden rounded-t-xl bg-gradient-to-br from-primary-50 to-primary-100">
                    ...
                    <div
                      className={`${p.image ? "hidden" : "flex"} items-center justify-center h-full text-primary-300`}
                    >
                      <Briefcase size={40} />
                    </div>
                  </div>
                  <Card.Body>
                    <div className="mb-3">
                      <Badge.Status status={p.status} />
                    </div>
                    <Card.Title>{p.title}</Card.Title>
                    <Card.Text>{p.description}</Card.Text>
                    {p.outcomes.length > 0 && (
                      <div className="mt-3">
                        <strong className="text-xs text-primary-600 uppercase tracking-wider">
                          Key Outcomes:
                        </strong>
                        <ul className="list-none p-0 mt-2">
                          {p.outcomes.map((o, i) => (
                            <li key={i} className="text-xs text-gray-600 py-1">
                              ✓ {o}
                            </li>
                          ))}
                        </ul>
                    ...
                    <Card.Meta>
                      <Card.MetaItem icon={Users}>
                        {p.beneficiaries}
                      </Card.MetaItem>
                      <Card.MetaItem icon={MapPin}>{p.location}</Card.MetaItem>
                    </Card.Meta>
                  </Card.Body>
                </Card>
              ))}
